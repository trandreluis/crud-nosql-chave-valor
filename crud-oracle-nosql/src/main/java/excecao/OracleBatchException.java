...
public class OracleBatchException extends OracleException {
	...
	/**
	 * Constructs an <code>OracleBatchException</code> object with a given
	 * message.
	 *
	 * @param message
	 *            the description of the error. <code>null</code> if message
	 *            string is non-existent
	 */
	...
	/**
	 * Constructs an <code>OracleBatchException</code> with a given message and
	 * an error code.
	 *
	 * @param message
	 ...
	 *
	 * @param cause
	 *            the cause of the error. <code>null</code> if non-existent
	 */
	 ...
	 * Number of operations processed before the error occurred.
	 *
	 * @return number of operations processed before the error occurred
	 */
